 ...
 * Date: 2015-10-11
 * Modified By: Allan (vseven) to add the valve capability
 */
 metadata {
 	definition (name: "Wemo Switch As Valve", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.smartplug") {
        capability "Actuator"
        capability "Switch"
        capability "Polling"
        capability "Refresh"
