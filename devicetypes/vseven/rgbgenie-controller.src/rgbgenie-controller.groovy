 ...
 *  Modified by Allan (vseven) on 2018-09-28 to be used by the RGBgenie Controller
 */
...
metadata {
    definition (name: "RGBgenie RGBW Controller", namespace: "vseven", author: "SmartThings - Modified by Allan (vseven)", mnmn: "SmartThings", vid: "generic-rgbw-color-bulb") {
       ...
       fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006,0008,0300,0B05", outClusters: "0019", manufacturer: "RGBgenie", model: "ZigBee RGBW LED Controller (Zigbee)", deviceJoinName: "RGBgenie Controller RGBW"
