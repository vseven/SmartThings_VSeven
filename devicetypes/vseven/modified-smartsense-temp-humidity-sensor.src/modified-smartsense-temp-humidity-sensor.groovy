...
metadata {
	...
	preferences {
		section("Prefs") {
			input "primarySensor", "enum", options: ["temperature":"Temperature", "humidity":"Humidity"], defaultValue: "temperature", title: "Choose the sensor you want to appear as the primary value, either temperature or humidity.", displayDuringSetup: true
	...
	tiles(scale: 2) {
		if ($settings.primarySensor=="temperature") {
