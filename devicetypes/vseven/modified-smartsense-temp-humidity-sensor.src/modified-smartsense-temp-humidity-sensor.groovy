...
metadata {
	...
	preferences {
		section("Prefs") {
			input "primarySensor", "enum", options: ["temperature":"Temperature Value", "humidity":"Humidity Value"], defaultValue: "temperature", title: "Choose the value you want to appear first both on the things list and the primary display tile, either temperature or humidity.", displayDuringSetup: true
