...
metadata {
	...
	preferences {
		input "primarySensor", type: "enum", title: "Choose the sensor you want to appear as the primary value, either temperature or humidity.", options: ["Temperature", "Humidity"], displayDuringSetup: false
