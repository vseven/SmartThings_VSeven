...
metadata {
	definition (name: "Child Contact Sensor Enhanced with Runtime", namespace: "vseven", author: "Dan Ogorchock (Modified by vseven)", mnmn: "SmartThings", vid: "generic-contact") {
