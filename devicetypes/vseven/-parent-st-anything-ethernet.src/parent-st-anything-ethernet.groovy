 ...
 *    2017-08-29  Allan (vseven) Modified to use a GenerateEvent instead of SendEvent to allow future customization
 *    2017-09-09  Allan (vseven) Changed the namespace so Todd can download without conflicting with his copy from Dan.
 *
 */
 
metadata {
	definition (name: "Parent_ST_Anything_Ethernet", namespace: "vseven", author: "Dan Ogorchock") {
		...
		try {
            ...
            if (childDevice != null) {
                ...
                if (namebase == "doorControl") {
                	childDevice.generateEvent("contact", value)
