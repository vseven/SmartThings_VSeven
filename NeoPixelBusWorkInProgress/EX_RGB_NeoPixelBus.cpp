...
namespace st
{
	...
	//private
	void EX_RGB_NeoPixelBus<T_COLOR_FEATURE, T_METHOD>::writeCommandToOutput()
	{
		uint8_t R;
		uint8_t G;
		uint8_t B;
...
//public
	//constructor
	EX_RGB_NeoPixelBus<T_COLOR_FEATURE, T_METHOD>::EX_RGB_NeoPixelBus(const __FlashStringHelper *name, uint16_t pixelCount, uint8_t pinRGB):
		Executor(name),
		m_nStrip(pixelCount,pinRGB)
	{
