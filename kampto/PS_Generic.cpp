...
//public
	...
	PS_Generic::PS_Generic(const __FlashStringHelper *name, unsigned int interval, int offset, int passedValue):
		PollingSensor(name, interval, offset),m_nSensorValue(0)
		{
			setPassedValue(passedValue);
		}
	...
	void PS_Generic::setPassedValue(int value)
	{
		m_nPassedValue=value;
	}
