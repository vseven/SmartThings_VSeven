...
//				- uint16_t count - REQUIRED - the number of programmable pixels in the RGB strip
//
//  Change History:
//
//    Date        Who            What
...
namespace st
{
	class EX_RGB_NeoPixelBus: public Executor
	{
		private:
			...
			NeoPixelBus<NeoGrbFeature, NeoEsp32I2s1800KbpsMethod> m_nStrip;		
	public:
			//constructor - called in your sketch's global variable declaration section
			EX_RGB_NeoPixelBus(const __FlashStringHelper *name, byte pixelCount, byte pinRGB);
