...
#include <EX_RGB_NeoPixelBus.h>      //Implements an Executor (EX) for a RGB LED strip using the NeoPixelBus library
...
//******************************************************************************************
String str_ssid     = "SSID_HERE";                           //  <---You must edit this line!
String str_password = "PASSWORD_HERE";                   //  <---You must edit this line!
IPAddress ip(192, 168, 1, 120);       //Device IP Address       //  <---You must edit this line!
