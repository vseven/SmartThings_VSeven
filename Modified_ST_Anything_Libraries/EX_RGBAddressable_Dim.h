...
//
//******************************************************************************************
#ifndef ST_EX_RGBAddressable_Dim
#define ST_EX_RGBAddressable_Dim
...
namespace st
{
	class EX_RGBAddressable_Dim: public Executor
	{
		private:
		...
		public:
			...
			EX_RGBAddressable_Dim(const __FlashStringHelper *name, byte pinRGB, byte pixelCount);
			
			//destructor
			virtual ~EX_RGBAddressable_Dim();
